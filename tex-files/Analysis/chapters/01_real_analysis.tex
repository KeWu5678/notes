...
\paragraph{Parameter dependant integral}
...
\begin{theorem}[The implicit function theorem]
	...
	\begin{align*}
		f(x_0, y_0) = 0, \quad  D_2 f(x_0, y_0) \in Lis(E_2, F),
	\end{align*}
...
\begin{definition}[Total variation]
	...
	\begin{align*}
		\operatorname{var}(f, I):= \sup \{ \sum_{k = 1}^n |f(t_k) - f(t_{k-1})|: (t_0, \dots, t_n) \textbf{is a partition of } I \}
	\end{align*}
\end{definition}
...
\begin{proof}.
	\begin{itemize}
		...
		\begin{align*}
			L_{\xi_1} + L_{\xi_2} + \epsilon &\geq \operatorname{Var}(f, [a, c]) + \operatorname{Var}(f, [c, b])\\
		\Rightarrow	
		\operatorname{Var}(f, [a, b]) \geq L_{\xi_1 \wedge \xi_2}  &\geq \operatorname{Var}(f, [a, c]) + \operatorname{Var}(f, [c, b])-\epsilon
		\end{align*} 
	\end{itemize}
\end{proof}

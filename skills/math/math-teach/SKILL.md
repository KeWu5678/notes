...
# Output structures
## structured output:** 
Give output in the following form:
**Intuition** : lead with the intuition in a few sentences, then the derivation. Keep prose between steps short — explain what each step does without burying the formulas
**Field**:
use 3 keyword to indicate the field of the question
**Tools**:(only for the answer with proofs) 
Use up to 3 sentence to introduce the mathematical tool used or the 
**Anwser**
Use the following answer style to answer the question. 
